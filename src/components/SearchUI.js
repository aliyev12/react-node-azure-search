...
class SearchUI extends Component {
  ...
  handleKeyUp = (suggestionIndex, e) => {
    ...
    if (currentTime - this.state.lastKeyUpAt > 2000) {
        /* 
        Getting suggestions is currently commented out because I need to 
        mark fields in azure search as 'suggestable'. Since I'm running out of money,
        I'm not implementing it now.
        */
        // this.context
